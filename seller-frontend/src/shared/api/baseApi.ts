...
export const baseApi = createApi({
  ...
  baseQuery: fetchBaseQuery({
    ...
    prepareHeaders: (headers) => {
      const token =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI5OWI3MWFiNi1iMTdiLTQ5NDYtOTlhZC1lMzVjZmFiZjQ1ZGYiLCJpc1NlbGxlciI6dHJ1ZX0.vpSRNgkvXloURltgIaGB62aEbcOi6_NxCPHBkSDqyoc";
